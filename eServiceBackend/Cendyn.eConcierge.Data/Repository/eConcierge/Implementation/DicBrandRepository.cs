...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class DicBrandRepository: EntityRepository<DicBrand,ConciergeEntities>,IDicBrandRepository
    {
    	public DicBrandRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
