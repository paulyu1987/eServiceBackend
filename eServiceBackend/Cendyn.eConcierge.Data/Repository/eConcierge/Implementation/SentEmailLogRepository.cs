...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class SentEmailLogRepository: EntityRepository<SentEmailLog,ConciergeEntities>,ISentEmailLogRepository
    {
    	public SentEmailLogRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
