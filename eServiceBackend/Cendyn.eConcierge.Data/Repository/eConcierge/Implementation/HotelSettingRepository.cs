...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class HotelSettingRepository: EntityRepository<HotelSetting,ConciergeEntities>,IHotelSettingRepository
    {
    	public HotelSettingRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
