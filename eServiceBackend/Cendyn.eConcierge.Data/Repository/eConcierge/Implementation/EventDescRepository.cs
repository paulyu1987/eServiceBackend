...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class EventDescRepository: EntityRepository<EventDesc,ConciergeEntities>,IEventDescRepository
    {
    	public EventDescRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
