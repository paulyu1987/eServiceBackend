...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class DicChainRepository: EntityRepository<DicChain,ConciergeEntities>,IDicChainRepository
    {
    	public DicChainRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
