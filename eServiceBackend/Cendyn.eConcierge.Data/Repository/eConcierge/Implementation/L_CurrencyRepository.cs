...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class L_CurrencyRepository: EntityRepository<L_Currency,ConciergeEntities>,IL_CurrencyRepository
    {
    	public L_CurrencyRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
