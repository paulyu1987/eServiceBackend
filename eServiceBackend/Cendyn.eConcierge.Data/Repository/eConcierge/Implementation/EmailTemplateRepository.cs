...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class EmailTemplateRepository: EntityRepository<EmailTemplate,ConciergeEntities>,IEmailTemplateRepository
    {
    	public EmailTemplateRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
