...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class LanguageRepository: EntityRepository<Language,ConciergeEntities>,ILanguageRepository
    {
    	public LanguageRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
