...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class FGuestRepository: EntityRepository<FGuest,ConciergeEntities>,IFGuestRepository
    {
    	public FGuestRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
