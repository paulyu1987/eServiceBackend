...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class L_DateFormatRepository: EntityRepository<L_DateFormat,ConciergeEntities>,IL_DateFormatRepository
    {
    	public L_DateFormatRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
