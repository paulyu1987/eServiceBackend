...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class SettingRepository: EntityRepository<setting,ConciergeEntities>,ISettingRepository
    {
    	public SettingRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
