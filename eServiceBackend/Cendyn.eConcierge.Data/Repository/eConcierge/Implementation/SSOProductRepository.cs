...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class SSOProductRepository: EntityRepository<SSOProduct,ConciergeEntities>,ISSOProductRepository
    {
    	public SSOProductRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
