...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class RateTypeLogRepository: EntityRepository<RateTypeLog,ConciergeEntities>,IRateTypeLogRepository
    {
    	public RateTypeLogRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
