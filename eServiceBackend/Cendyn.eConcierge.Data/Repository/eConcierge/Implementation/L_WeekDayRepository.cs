...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class L_WeekDayRepository: EntityRepository<L_WeekDay,ConciergeEntities>,IL_WeekDayRepository
    {
    	public L_WeekDayRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
