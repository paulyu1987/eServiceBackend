...
namespace Cendyn.eConcierge.Data.Repository.eConcierge.Implementation
{
    ...
    public  partial class RoomImageRepository: EntityRepository<RoomImage,ConciergeEntities>,IRoomImageRepository
    {
    	public RoomImageRepository(IServiceLocator serviceLocator)
                : base(serviceLocator)
            {
